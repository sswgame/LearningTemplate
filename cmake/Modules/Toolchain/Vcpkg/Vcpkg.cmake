...
# Keep VCPKG_MANIFEST_MODE ON once a build dir used it — flipping OFF mid-life is rejected by
# vcpkg.cmake. Skip reinstall via VCPKG_MANIFEST_INSTALL instead of toggling mode.
if(SW_VCPKG_FORCE_INSTALL)
    set(VCPKG_MANIFEST_MODE ON CACHE BOOL "vcpkg manifest mode" FORCE)
    set(VCPKG_MANIFEST_INSTALL ON CACHE BOOL "vcpkg auto-install from manifest" FORCE)
    message(STATUS "[vcpkg] SW_VCPKG_FORCE_INSTALL=ON — manifest install enabled")
elseif(_sw_tree_ready AND _sw_stamp_match)
    set(VCPKG_MANIFEST_MODE ON CACHE BOOL "vcpkg manifest mode" FORCE)
    set(VCPKG_MANIFEST_INSTALL OFF CACHE BOOL "vcpkg auto-install from manifest" FORCE)
