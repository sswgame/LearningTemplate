...
function(sw_addReflectionStep TARGET_NAME)
    ...
    if(NOT ARG_HEADERS)
        ...
        foreach(_hdr IN LISTS _all_headers)
            file(STRINGS "${_hdr}" _has_reflect REGEX "^[ \t]*(REFLECT\\(|REFLECT_SCRIPT|ENUM\\(|REFLECT_CONTAINER\\()")
            if(_has_reflect)
                list(APPEND ARG_HEADERS "${_hdr}")
            endif()
        endforeach()
        if(NOT ARG_HEADERS)
            message(WARNING "[Reflection] Auto-scan found no headers with REFLECT macros for target: ${TARGET_NAME}")
            return()
        endif()
    endif()
