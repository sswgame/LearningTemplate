...
int main( int argc, char* argv[] )
{
	...
	componentManager->registerPendingFactories( "Core", sw::ComponentFactoryRegistrar::getHead() );
	componentManager->registerPendingFactories( "TestFramework", swTestComponentFactoryHead() );
