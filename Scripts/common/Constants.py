...
kScriptLintCheckEngineLayers = "Scripts/lint/gate/CheckEngineLayers.py"
kScriptLintCheckIncludeOrder = "Scripts/lint/gate/CheckIncludeOrder.py"
kScriptLintCheckResourceCasing = "Scripts/lint/gate/CheckResourceCasing.py"
kScriptLintCheckCodeConventions = "Scripts/lint/gate/CheckCodeConventions.py"
kScriptLintCheckSourceGlob = "Scripts/lint/gate/CheckSourceGlob.py"
kScriptLintCheckDataFileReferences = "Scripts/lint/gate/CheckDataFileReferences.py"
kScriptLintCheckRenderOwnership = "Scripts/lint/gate/CheckRenderOwnership.py"
kScriptLintCheckTestSuites = "Scripts/lint/gate/CheckTestSuites.py"
kScriptLintCheckFunctionVocabulary = "Scripts/lint/gate/CheckFunctionVocabulary.py"
kScriptLintCheckCodeConventionsSelfTest = "Scripts/lint/selftest/CheckCodeConventionsSelfTest.py"
kScriptLintCheckLintsAreAlive = "Scripts/lint/selftest/CheckLintsAreAlive.py"
kScriptLintRunClangFormat = "Scripts/lint/report/RunClangFormat.py"
