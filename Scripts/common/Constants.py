...
kScriptLintCheckDataFileReferences = "Scripts/lint/CheckDataFileReferences.py"
kScriptLintCheckRenderOwnership = "Scripts/lint/CheckRenderOwnership.py"
kScriptLintCheckTestSuites = "Scripts/lint/CheckTestSuites.py"
kScriptLintCheckCodeConventionsSelfTest = "Scripts/lint/CheckCodeConventionsSelfTest.py"
