 ...
 * @brief 게임 모듈의 진입점(C-ABI) 구현을 위한 매크로 모음입니다.
 *
 * @note 이 헤더는 **경계 계약이 아니라 모듈 쪽 접착제**입니다. 그래서 `ABI/` 와 달리 모듈 자신의
 *       서비스 로케이터(`GameFramework/`)를 끌어옵니다. 모듈 구현 `.cpp` 만 include 합니다.
 */
#pragma once
