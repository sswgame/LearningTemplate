 ...
 * @brief Windows 전용(Win32 GDI 기반) ISplashWindow 구현입니다.
 */
#pragma once
...
namespace sw
{
     ...
     * @brief Win32 API 기반의 가벼운 스플래시 창입니다.
     */
    ...
    private:
        ...
        HGDIOBJ _hBackgroundPreviousBitmap; ///< 골라 넣기 전의 비트맵. 놓을 때 되돌림
        HFONT   _hStatusFont;               ///< 상태 줄 글꼴(처음 그릴 때 한 번 만듦)
