 ...
 * @brief Linux X11 기반 ISplashWindow 구현입니다.
 */
#pragma once
...
namespace sw
{
     ...
     * @brief Linux X11 기반의 가벼운 스플래시 창입니다.
     */
    ...
    private:
        ...
        [[maybe_unused]] uint64 _x11Pixmap;       /**< 창 배경으로 걸어 두는 그림. 서버가 알아서 다시 그림. */
        vector<uint8>           _listScaledPixel; /**< 창 크기로 줄인 BGRA 픽셀. 비어 있으면 그리지 않음. */
    };
} // namespace sw
