...
namespace sw
{
	...
	struct RawInputEvent
	{
		...
		static RawInputEvent makeKeyDown( Key key, uint16 vk = 0, bool bRepeat = false )
		{
			RawInputEvent evt{};
		...
		static RawInputEvent makeKeyUp( Key key, uint16 vk = 0 )
		{
			RawInputEvent evt{};
		...
		static RawInputEvent makeMouseButtonDown( MouseButton btn, int32 x = 0, int32 y = 0 )
		{
			RawInputEvent evt{};
		...
		static RawInputEvent makeMouseButtonUp( MouseButton btn, int32 x = 0, int32 y = 0 )
		{
			RawInputEvent evt{};
		...
		static RawInputEvent makeTextInput( string_view text )
		{
			...
			for ( size_t charIndex = 0; charIndex < len; ++charIndex )
				evt._payload._textData._arrUtf8[charIndex] = text[charIndex];
