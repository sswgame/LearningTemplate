 ...
 * 합니다(`Dimension=BUFFER` · `Height=1` · `DepthOrArraySize=1` · `MipLevels=1` · `Format=UNKNOWN` ·
 ...
 *
 * @note 크기를 `uint64` 로 받습니다. 예전 한 곳은 `elementSize * elementCount` 를 **32비트로 곱해**
 *       `Width`(UINT64)에 넣고 있었습니다. 넘치면 조용히 작은 버퍼가 됩니다.
 */
#pragma once
