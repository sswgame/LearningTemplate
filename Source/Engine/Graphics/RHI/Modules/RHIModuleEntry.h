 ...
 * @details 예전에는 백엔드마다 ModuleEntry.cpp 에 같은 25줄을 복사해 두고 클래스 이름만 바꿨습니다.
 *          진입점이 하나 늘 때마다 4곳을 고쳐야 했고, ABI 스탬프 규약이 흩어져 있었습니다.
 *          게임 모듈의 SW_IMPLEMENT_GAME_MODULE 과 같은 방식으로 한곳에 모읍니다.
