...
namespace sw
{
	namespace
	{
		...
		{
			assignIfPresent( config._llvmClangRel, obj, jsonKeyConstants::kLlvmClangRel );
			assignIfPresent( config._clangIncludeRel, obj, jsonKeyConstants::kClangIncludeRel );
			assignIfPresent( config._msvcIncludeRel, obj, jsonKeyConstants::kMsvcIncludeRel );
			assignIfPresent( config._winSdkIncludeRel, obj, jsonKeyConstants::kWinSdkIncludeRel );
			assignIfPresent( config._winSdkUcrtRel, obj, jsonKeyConstants::kWinSdkUcrtRel );
		}

		static void applyClangFlagsSection( ParserClangConfig& config, const nlohmann::json& obj )
		{
			assignIfPresent( config._flagIncludePrefix, obj, jsonKeyConstants::kFlagIncludePrefix );
			assignIfPresent( config._flagIsystem, obj, jsonKeyConstants::kFlagIsystem );
			assignIfPresent( config._flagResourceDir, obj, jsonKeyConstants::kFlagResourceDir );
			assignIfPresent( config._flagForceInclude, obj, jsonKeyConstants::kFlagForceInclude );
			assignIfPresent( config._flagFmsCompatibility, obj, jsonKeyConstants::kFlagFmsCompatibility );
			assignIfPresent( config._flagFmsExtensions, obj, jsonKeyConstants::kFlagFmsExtensions );
			assignIfPresent( config._flagFmsCompatVersionPrefix, obj, jsonKeyConstants::kFlagFmsCompatVerPrefix );
		}

		static void applyEmitSection( ParserClangConfig& config, const nlohmann::json& obj )
		{
			assignIfPresent( config._emitCppExtension, obj, jsonKeyConstants::kEmitCppExtension );
			assignIfPresent( config._emitHeaderExtension, obj, jsonKeyConstants::kEmitHeaderExtension );
			assignIfPresent( config._emitTemplateExtension, obj, jsonKeyConstants::kEmitTemplateExtension );
			assignIfPresent( config._emitAutoGeneratedBanner, obj, jsonKeyConstants::kEmitAutoGeneratedBanner );
			assignIfPresent( config._emitPlaceholderMarker, obj, jsonKeyConstants::kEmitPlaceholderMarker );
			assignIfPresent( config._emitRegenByParserMarker, obj, jsonKeyConstants::kEmitRegenMarker );
			assignIfPresent( config._emitGeneratedNsOpen, obj, jsonKeyConstants::kEmitGeneratedNsOpen );
			assignIfPresent( config._emitGeneratedNsClose, obj, jsonKeyConstants::kEmitGeneratedNsClose );
		}
